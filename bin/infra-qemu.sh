...
qemu-system-x86_64 -m 1024 -nographic --enable-kvm -drive file=fat:rw:~/.dotfiles/boot,format=vvfat,label=CONFIG  --cdrom $ISO -global driver=cfi.pflash01,property=secure,value=on -drive if=pflash,format=raw,unit=0,file="/usr/share/OVMF/OVMF_CODE.fd",readonly=on -fw_cfg name=opt/io.dracut/cmdline,string="root=live:/dev/disk/by-label/ISO $1" -smbios type=11,value=io.dracut:cmdline=ro
